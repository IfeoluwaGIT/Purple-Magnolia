      ...
      <Flex ml={10} mr={10} justify="space-around" wrap="wrap" px={4}>
        ...
        <Box flexBasis={{ base: "100%", md: "30%" }} textAlign={{ base: "center", md: "left" }} mb={{ base: 4, md: 0 }} >
          <Heading as="h1" fontSize="lg" mb={2}>
            <Image src="/beji.jpg" alt="Logo" width={10} height={10} />
          </Heading>
          <Text mb={2}>
            A brief description or tagline about the bookstore, expressing its mission or vision.
          </Text>
        ...
        <Box flexBasis={{ base: "100%", md: "30%" }} textAlign={{ base: "center", md: "center" }} mb={{ base: 4, md: 0 }}>
          ...
          <Flex direction="column">
            ...
            <Link href="#" mb={2}>New Releases</Link>
        ...
        <Box flexBasis={{ base: "100%", md: "30%" }} textAlign={{ base: "center", md: "left" }}>
          ...
          <Flex align="center">
            <Image src="https://images.pexels.com/photos/11288706/pexels-photo-11288706.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=2" alt="Latest News" boxSize="100px" mr={4} />
            <Text>
